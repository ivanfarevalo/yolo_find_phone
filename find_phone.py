...
from models.load_models import attempt_load
# from utils.datasets import LoadStreams, LoadImages
from utils.data_loader import LoadImages
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        if opt.update:  # update all models (to fix SourceChangeWarning)
            ...
            opt.classes = 67 # Cell Phone class.
            opt.conf_thres = 0.01 # Low threshold since we know there is a single cell phone in each image
            opt.img_size = 448 # Helps identify the smaller phones in the image
            # detect()
            inference()
